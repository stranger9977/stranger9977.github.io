...
LOL.plot('plot-14', traces, {
  ...
  shapes:[{type:'line', x0:eras[0], x1:eras[3], y0:25, y1:25, line:{color:LOL.MUTED,width:1,dash:'dash'}}],
...
LOL.plot('plot-15', traces, {
  ...
  shapes:[{type:'line', x0:1, x1:10, y0:10, y1:10, line:{color:LOL.MUTED,width:1,dash:'dash'}}],
...
LOL.plot('plot-19', traces, {
  ...
  shapes:[{type:'line', x0:eras[0], x1:eras[3], y0:25, y1:25, line:{color:LOL.MUTED,width:1,dash:'dash'}}],
  annotations:series.map(function(s){return {x:eras[3], y:s.y[3], xanchor:'left', xshift:8, text:s.name+' '+s.y[3]+'%', showarrow:false, font:{color:s.color, size:11.5}};}).concat([{x:eras[0], y:25, xanchor:'right', xshift:-8, text:'proportional share, 25%', showarrow:false, font:{color:LOL.MUTED, size:10.5}}])
});
/* plot-21 */
